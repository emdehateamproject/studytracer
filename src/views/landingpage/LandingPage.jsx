  ...
  return (
    <>
          <PageContainer>
            ...
            <p>UAD telah meluncurukan SITTra (Sistem Informasi dan Teknologi Tracer) 2019.<br/>
    ...
    Silahkan klik LOG IN dan masukkan NIM dan password anda. Selamat berpartisipasi dan sukses selalu bagi para Alumni UAD</p>
          </PageContainer>
    </>
  )
}
